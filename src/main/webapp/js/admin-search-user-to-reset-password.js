Ext.onReady(function(){
    ...
    // alert('in admin-search-user-to-reset-password page!');
  ...
  /*  var deactivateUserCheckbox = {
    ...
    var resetUserPasswordForm = new Ext.FormPanel({
    	name: 'searchUserForm',
        id: 'searchUserForm',
        title: 'Search User',
        ...
        buttons: [{
            ...
            handler: function()
            {
            	fnSubmitRequest(resetUserPasswordForm);
            }
        },{
            text: 'Reset',
            disabled: false,
            handler: function() {
            	fnResetForm(resetUserPasswordForm);
            }
        }]
    });    
...
function fnSubmitRequest(theForm)
{
	theForm.getForm().submit(
		{
			url: 'admin-reset-user-password.action',
    		waitMsg: 'resetting the password...',
    		success: function(form, action)
    		{
    			var jsonData = Ext.util.JSON.decode(action.response.responseText);
    			var newPassword = jsonData.data;
    			  
    			Ext.Msg.alert('Success', 'Successfully reset password. <br /> New password is: ' + newPassword);
    			fnResetForm(theForm);
    		},
