...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<!-- App js -->
		<!-- <script src="js/admin-createRequest.js"></script> -->
		
		<script src="js/owner-house-bean.js"></script>
		<script src="js/owner-bean.js"></script>
		<script src="js/lessee-bean.js"></script>
		<script src="js/admin-user-maintenance.js"></script>
