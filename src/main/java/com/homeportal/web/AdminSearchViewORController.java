 ...
 */
@Controller
public class AdminSearchViewORController {
    
    @RequestMapping("/admin-searchViewOR")
    String view(HttpSession session) throws Exception {
         System.out.println("went to view of AdminSearchViewORController ");
